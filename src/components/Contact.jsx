					...
					<div className="w-full lg:w-1/2 xl:w-6/12 px-4">
						<div className="max-w-[570px] mx-5 mb-12 lg:mb-0">
							...
							<div className="flex gap-5 w-full justify-center items-center">
								<BsWhatsapp
									size={30}
									className="text-gray-600 hover:text-green-500 hover:scale-105 ease-in duration-300"
								/>
								<BsInstagram
									size={30}
									className="text-gray-600 hover:text-pink-600 hover:scale-105 ease-in duration-300"
								/>
								<BsFacebook
									size={30}
									className="text-gray-600 hover:text-blue-700 hover:scale-105 ease-in duration-300"
								/>
							</div>
						</div>
					</div>
